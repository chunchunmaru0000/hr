...
Далее переменая, аргумнент и поле будут взаимозаменяемыми понятимя и иметь возможный синтаксис:
...
;; эти идеи противоречат правилам ;;
...
имя: тип_вырж = глобальное_выражение
